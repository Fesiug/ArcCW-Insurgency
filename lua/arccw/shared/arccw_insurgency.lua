...
--[[ Order!
	...
	-- AKS-74U
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Magrelease",	"weapons/arccw_ins2/aks74u/handling/AKS_magrelease.wav",	CHAN_ITEM, 0.2, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Magout",		"weapons/arccw_ins2/aks74u/handling/AKS_magout.wav",		CHAN_ITEM, 0.2, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.MagoutRattle","weapons/arccw_ins2/aks74u/handling/AKS_magout_rattle.wav",	CHAN_ITEM, 0.2, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Rattle",		"weapons/arccw_ins2/aks74u/handling/AKS_rattle.wav",		CHAN_ITEM, 0.2, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Magin",		"weapons/arccw_ins2/aks74u/handling/AKS_magin.wav",			CHAN_ITEM, 0.2, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Boltback",	"weapons/arccw_ins2/aks74u/handling/AKS_boltback.wav",		CHAN_ITEM, 0.3, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.Boltrelease",	"weapons/arccw_ins2/aks74u/handling/AKS_boltrelease.wav",	CHAN_ITEM, 0.3, 65, 100 )
		ArcCW_Insurgency:AddSound( "Weapon_AKS74U.ROF",	        "weapons/arccw_ins2/aks74u/handling/AKS_fireselect_1.wav",	CHAN_ITEM, 0.2, 65, 100 )
